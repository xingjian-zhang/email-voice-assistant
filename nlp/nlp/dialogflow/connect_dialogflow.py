...
if __name__ == "__main__":
    ...
    session_id="me"
    language_code="en-US"
    texts=['hello', "Mark today's emails as read","Forward this email to 1728669434@qq.com","delete this email"]
    detect_intent_texts(
        project_id, session_id, texts, language_code
    )
#python connect_dialogflow.py --project-id test-conv-ai-1011 --session-id me "hello" "Mark today's emails as read"